      ...
      return (
            <div className="h-[calc(100vh-56px)] bg-[#060d19] flex overflow-hidden">
                  ...
                  <div className="flex-1 overflow-y-auto p-6">
                          ...
                          <div className="bg-green-500/5 border border-green-500/10 rounded-lg p-4 mb-6"><div className="text-green-400 text-[10px] font-mono tracking-wider mb-1">TRIGGERING EVENT</div>div><div className="text-white/80 text-sm font-mono">{signal.triggerEvent}</div>div><div className="text-white/40 text-[10px] font-mono mt-1">military escalation · Severity {signal.severity}% · {signal.eventTime}</div>div></div>div>
