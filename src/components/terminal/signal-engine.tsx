...
export default function SignalEngine() {
  ...
  const signals = [
    { ticker: "HSI", name: "Hang Seng", direction: "SELL", confidence: 90, price: 17234.20, change: -0.2, assetClass: "Equity Indices", bullish: 0, bearish: 63, volatility: "HIGH", timeframe: "short-term", rr: 2.0, entry: 17234.20, stopLoss: 16889.52, target: 17923.57, atr: 1.84, maxPos: 3.2, triggerEvent: "US-China Trade Tariff Expansion — Sentiments shifting toward risk-off as new tariff measures announced", geoSensitivity: ["trade restrictions", "political instability"], reasoning: "AI detected significant bearish momentum following the expansion of US-China trade tariffs. Sentiment analysis across 847 news sources shows 78% negative outlook. Historical pattern matching indicates similar tariff events led to 3-5% HSI declines within 2 weeks. Technical indicators confirm bearish divergence on RSI and MACD.", timeline: [{ time: "08:00", event: "US announces expanded tariff list" }, { time: "09:15", event: "China retaliatory measures leaked" }, { time: "10:30", event: "Asian markets react with broad selloff" }, { time: "11:45", event: "HSI breaks key support at 17,400" }, { time: "12:01", event: "Signal generated - SELL HSI" }], reliability: { backtestWinRate: 72, signalCount: 156, avgReturn: 3.8, sharpeRatio: 1.92, maxDrawdown: -4.2 } },
    { ticker: "XAUUSD", name: "Gold", direction: "BUY", confidence: 88, price: 2314.50, change: 1.2, assetClass: "Commodities", bullish: 67, bearish: 0, volatility: "HIGH", timeframe: "short-term", rr: 2.0, entry: 2341.00, stopLoss: 2298.00, target: 2427.00, atr: 1.84, maxPos: 3.2, triggerEvent: "Iran-Israel Escalation — Missile Exchanges driving safe-haven demand across precious metals", geoSensitivity: ["military escalation", "energy supply disruption"], reasoning: "Geopolitical risk premium surging as Iran-Israel conflict escalates. Gold historically rallies 2-4% in first week of major Middle East military events. Safe-haven flows detected across 12 institutional order books. Correlation with VIX spike at 0.87 confirms risk-off rotation. Entry at 2341 offers favorable risk/reward with ATR-based stops.", timeline: [{ time: "06:00", event: "Iran missile launch reports confirmed" }, { time: "07:30", event: "Israel retaliatory strikes announced" }, { time: "09:00", event: "Gold surges past 2300 resistance" }, { time: "10:45", event: "Safe-haven flows accelerate" }, { time: "12:01", event: "Signal generated - BUY XAUUSD" }], reliability: { backtestWinRate: 75, signalCount: 203, avgReturn: 4.2, sharpeRatio: 2.15, maxDrawdown: -3.1 } },
    { ticker: "ITA", name: "Defense ETF (ITA)", direction: "BUY", confidence: 87, price: 142.50, change: 2.3, assetClass: "ETFs", bullish: 67, bearish: 0, volatility: "HIGH", timeframe: "short-term", rr: 2.0, entry: 142.50, stopLoss: 139.65, target: 148.20, atr: 1.56, maxPos: 2.5, triggerEvent: "Iran-Israel Escalation — Defense sector rotation on military escalation", geoSensitivity: ["military escalation"], reasoning: "Defense sector ETF showing strong momentum as military conflict escalates. Historical analysis shows ITA outperforms by 5-8% during sustained geopolitical crises. Institutional flow data indicates $1.2B net inflows into defense stocks. Sector rotation confirmed by relative strength vs SPX.", timeline: [{ time: "07:00", event: "Military escalation confirmed" }, { time: "08:30", event: "Defense stocks gap up at open" }, { time: "10:00", event: "ITA volume 3x average" }, { time: "11:30", event: "Institutional buying detected" }, { time: "12:01", event: "Signal generated - BUY ITA" }], reliability: { backtestWinRate: 69, signalCount: 89, avgReturn: 3.5, sharpeRatio: 1.78, maxDrawdown: -5.1 } },
    { ticker: "BRENT", name: "Brent Oil", direction: "BUY", confidence: 87, price: 89.45, change: 3.1, assetClass: "Commodities", bullish: 67, bearish: 0, volatility: "HIGH", timeframe: "short-term", rr: 1.9, entry: 89.45, stopLoss: 86.50, target: 95.00, atr: 2.1, maxPos: 2.8, triggerEvent: "Iran-Israel Escalation — Strait of Hormuz supply disruption fears", geoSensitivity: ["energy supply disruption", "trade restrictions"], reasoning: "Oil prices surging on supply disruption fears. Strait of Hormuz handles 21% of global oil transit. Satellite imagery confirms naval deployments. Options market pricing 15% probability of sustained disruption. Brent premium to WTI widening signals physical market tightness.", timeline: [{ time: "05:00", event: "Naval deployment near Strait of Hormuz" }, { time: "07:00", event: "Shipping companies rerouting tankers" }, { time: "09:30", event: "Brent breaks above $88 resistance" }, { time: "11:00", event: "OPEC emergency meeting rumors" }, { time: "13:01", event: "Signal generated - BUY BRENT" }], reliability: { backtestWinRate: 71, signalCount: 178, avgReturn: 5.1, sharpeRatio: 1.85, maxDrawdown: -6.2 } },
    { ticker: "RTX", name: "Raytheon Technologies", direction: "BUY", confidence: 85, price: 98.20, change: 1.8, assetClass: "Stocks", bullish: 66, bearish: 0, volatility: "HIGH", timeframe: "short-term", rr: 2.0, entry: 98.20, stopLoss: 96.24, target: 102.12, atr: 1.72, maxPos: 2.0, triggerEvent: "Iran-Israel Escalation — Defense contractor demand surge", geoSensitivity: ["military escalation"], reasoning: "RTX positioned to benefit from increased defense spending. Congress fast-tracking supplemental defense budget. Backlog at record $190B. Earnings estimates being revised upward by 8-12% across sell-side analysts.", timeline: [{ time: "08:00", event: "Defense budget supplement proposed" }, { time: "09:30", event: "RTX gaps up on volume" }, { time: "11:00", event: "Analyst upgrades begin" }, { time: "12:00", event: "Signal generated - BUY RTX" }], reliability: { backtestWinRate: 67, signalCount: 92, avgReturn: 3.2, sharpeRatio: 1.65, maxDrawdown: -4.8 } },
    { ticker: "SPX", name: "S&P 500", direction: "SELL", confidence: 82, price: 5120.30, change: -1.5, assetClass: "Equity Indices", bullish: 0, bearish: 58, volatility: "HIGH", timeframe: "short-term", rr: 2.1, entry: 5120.30, stopLoss: 5200.00, target: 4950.00, atr: 1.2, maxPos: 2.5, triggerEvent: "Iran-Israel Escalation — Broad risk-off sentiment impacting equities", geoSensitivity: ["sanctions", "political instability"], reasoning: "S&P 500 facing multiple headwinds from geopolitical escalation. VIX surging above 25 signals institutional hedging. Put/call ratio at 1.4 confirms bearish positioning. Geopolitical risk events historically cause 3-7% SPX drawdowns. Technical breakdown below 50-day MA confirms bearish trend.", timeline: [{ time: "06:00", event: "Futures down 1.2% on escalation news" }, { time: "09:30", event: "Market opens with gap down" }, { time: "11:00", event: "VIX spikes above 25" }, { time: "12:30", event: "Selling accelerates into close" }, { time: "14:01", event: "Signal generated - SELL SPX" }], reliability: { backtestWinRate: 68, signalCount: 234, avgReturn: 3.9, sharpeRatio: 1.72, maxDrawdown: -5.5 } },
      ]
                                ...
                                <div className="space-y-4">
                                            ...
                                            <div className="grid grid-cols-2 gap-3">
                                                          <div className="bg-white/[0.02] border border-white/[0.04] rounded-lg p-3">
                                                                          <div className="text-white/40 text-[10px] font-mono">SOURCES ANALYZED</div>
                                            ...
                                            <div className="bg-white/[0.02] border border-white/[0.04] rounded-lg p-3">
                                                          <div className="text-white/40 text-[10px] font-mono mb-2">GEO SENSITIVITY FACTORS</div>div>
                                                          <div className="flex flex-wrap gap-2">{signal.geoSensitivity.map((g: string) => (<span key={g} className="text-[10px] font-mono px-2 py-1 rounded bg-amber-500/10 text-amber-400 border border-amber-500/20">{g}</span>span>))}</div>div>
                                            </div>div>
                                </div>div>
                              )
                      case "TIMELINE":
            ...
            <div className="h-[calc(100vh-56px)] bg-[#060d19] flex overflow-hidden">
                  <div className="w-72 border-r border-white/[0.06] flex flex-col bg-[#0a1628]/50">
                          <div className="p-3 border-b border-white/[0.06]">
                                    ...
                                    <div className="flex flex-wrap gap-1">
                                      {assetClasses.map(ac => (<button key={ac} onClick={() => { setAssetFilter(ac); setSelectedSignal(0) }} className={"px-2 py-1 rounded text-[10px] font-mono transition " + (assetFilter === ac ? "bg-[#1b9aaa]/20 text-[#1b9aaa] border border-[#1b9aaa]/30" : "text-white/50 hover:text-white/70")}>{ac}</button>button>))}
                                    </div>div>
                          </div>div>
                          <div className="p-3 border-b border-white/[0.06]">
                                    <div className="text-white/40 text-[10px] font-mono tracking-wider mb-2">DIRECTION</div>div>
                                    <div className="flex flex-wrap gap-1">
                                      {directions.map(d => (<button key={d} onClick={() => { setDirectionFilter(d); setSelectedSignal(0) }} className={"px-2 py-1 rounded text-[10px] font-mono transition " + (directionFilter === d ? "bg-[#1b9aaa]/20 text-[#1b9aaa] border border-[#1b9aaa]/30" : "text-white/50 hover:text-white/70")}>{d}</button>button>))}
                                    </div>div>
                          </div>div>
                          <div className="p-3 border-b border-white/[0.06]">
                                    <div className="text-white/40 text-[10px] font-mono tracking-wider mb-2">GEO SENSITIVITY</div>div>
                            {["military escalation", "energy supply disruption", "trade restrictions", "sanctions", "political instability"].map(s => (<div key={s} className="text-white/40 text-[10px] font-mono mb-1 hover:text-white/60 cursor-pointer">{s}</div>div>))}
                          </div>div>
                          <div className="p-3 border-b border-white/[0.06]">
                                    <input placeholder="Search asset..." value={searchTerm} onChange={e => { setSearchTerm(e.target.value); setSelectedSignal(0) }} className="w-full bg-white/5 border border-white/[0.08] rounded px-3 py-1.5 text-xs font-mono text-white placeholder-white/30 focus:outline-none focus:border-[#1b9aaa]/50" />
                          </div>div>
                          <div className="flex-1 overflow-y-auto">
                            {filtered.map((s, idx) => (<div key={idx} onClick={() => { setSelectedSignal(idx); setActiveDetailTab("TRADE SETUP") }} className={"p-3 border-b border-white/[0.04] cursor-pointer transition " + (selectedSignal === idx ? "bg-[#1b9aaa]/10 border-l-2 border-l-[#1b9aaa]" : "hover:bg-white/[0.02]")}>
                                        ...
                                        <div className="flex items-center gap-1 mt-1.5"><span className="text-white/30 text-[9px] font-mono px-1 py-0.5 rounded bg-white/5">VOL: {s.volatility}</span>span><span className="text-white/30 text-[9px] font-mono px-1 py-0.5 rounded bg-white/5">{s.timeframe}</span>span><span className="text-white/30 text-[9px] font-mono px-1 py-0.5 rounded bg-white/5">RR {s.rr}</span>span></div>div>
                  ...
                  <div className="flex-1 overflow-y-auto p-6">
                          ...
                          <div className="mb-6">
                                    ...
                                    <div className="flex items-center gap-4"><div className="flex-1 h-2 bg-white/5 rounded-full overflow-hidden"><div className="h-full bg-green-500" style={{width: signal.bullish + "%"}} /></div>div><span className="text-white/60 text-xs font-mono">{signal.bullish}%</span>span><span className="text-white/60 text-sm font-mono">Bearish Strength</span>span><div className="w-24 h-2 bg-white/5 rounded-full overflow-hidden"><div className="h-full bg-red-500" style={{width: signal.bearish + "%"}} /></div>div><span className="text-white/60 text-xs font-mono">{signal.bearish}%</span>span></div>div>
                          </div>div>
                          <div className="flex flex-wrap gap-2 mb-6">{["MEDIUM VOLATILITY", signal.timeframe, signal.assetClass.toLowerCase(), "global"].map(tag => (<span key={tag} className="text-[10px] font-mono px-2 py-1 rounded bg-amber-500/10 text-amber-400 border border-amber-500/20">{tag}</span>span>))}</div>div>
                          <div className="bg-green-500/5 border border-green-500/10 rounded-lg p-4 mb-6"><div className="text-green-400 text-[10px] font-mono tracking-wider mb-1">TRIGGERING EVENT</div>div><div className="text-white/80 text-sm font-mono">{signal.triggerEvent}</div>div></div>div>
                  ...
                  <div className="absolute bottom-0 left-0 right-0 z-20 bg-[#0a1628]/95 border-t border-white/[0.06] backdrop-blur-sm"><div className="flex items-center px-4 py-1.5 text-white/30 text-[10px] font-mono"><span>&#9888; Educational purposes only · Not financial advice · Model v1.0 · Auto-refresh 60s</span>span></div>div></div>div>
            </div>div>
          )
}</div>
