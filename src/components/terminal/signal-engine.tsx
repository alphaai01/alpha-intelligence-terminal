...
export default function SignalEngine() {
  ...
  const signals = [
    ...
    { ticker: "RTX", name: "Raytheon Technologies", direction: "BUY", confidence: 85, price: 98.20, change: 1.8, assetClass: "Stocks", bullish: 66, bearish: 0, volatility: "HIGH", timeframe: "short-term", rr: 2.0, entry: 98.20, stopLoss: 96.24, target: 102.10, atr: 1.5, maxPos: 2.5, triggerEvent: "Iran-Israel Escalation - Missile Exchanges", severity: 92.0, eventTime: "12:01", geoSensitivity: ["military escalation", "defense spending"], riskFactors: ["Peace negotiations", "Earnings miss"], reasoning: "Raytheon Technologies directly benefits from increased defense spending during geopolitical escalation. Missile defense systems in high demand. Order backlog expected to increase significantly. Technical breakout above $97 resistance confirmed.", timeline: [{ time: "06:00", event: "Escalation drives defense sector" }, { time: "08:30", event: "RTX gaps up on missile defense demand" }, { time: "10:00", event: "Breaks $97 resistance level" }, { time: "11:15", event: "Analyst upgrades begin" }, { time: "12:01", event: "Signal generated - BUY RTX" }], reliability: { backtestWinRate: 70, signalCount: 167, avgReturn: 3.5, sharpeRatio: 1.78, maxDrawdown: -4.8 } },
    { ticker: "SPX", name: "S&P 500", direction: "SELL", confidence: 82, price: 5120.30, change: -1.5, assetClass: "Equity Indices", bullish: 0, bearish: 58, volatility: "HIGH", timeframe: "short-term", rr: 2.1, entry: 5120.30, stopLoss: 5200.00, target: 4950.00, atr: 1.2, maxPos: 2.5, triggerEvent: "Iran-Israel Escalation - Missile Exchanges", severity: 92.0, eventTime: "12:01", geoSensitivity: ["sanctions", "political instability"], riskFactors: ["Market resilience", "Fed intervention"], reasoning: "S&P 500 facing multiple headwinds from geopolitical escalation. VIX surging above 25 signals institutional hedging. Put/call ratio at 1.4 confirms bearish positioning. Technical breakdown below 50-day MA confirms bearish trend.", timeline: [{ time: "06:00", event: "Futures down 1.2% on escalation news" }, { time: "09:30", event: "Market opens with gap down" }, { time: "11:00", event: "VIX spikes above 25" }, { time: "12:30", event: "Selling accelerates" }, { time: "14:01", event: "Signal generated - SELL SPX" }], reliability: { backtestWinRate: 68, signalCount: 234, avgReturn: 3.9, sharpeRatio: 1.72, maxDrawdown: -5.5 } },
      ]
  ...
  const renderDetailContent = () => {
                    ...
                    return (
                                <div>
                                            ...
                                            <div className="grid grid-cols-2 gap-3 mb-6">
                                                          ...
                                                          <div className="bg-white/[0.02] border border-green-500/10 rounded-lg p-3"><div className="text-green-400 text-[10px] font-mono">TARGET</div>div><div className="text-green-400 text-lg font-bold font-mono">{signal.target.toFixed(2)}</div></div>
                                            </div>div>
      ...
      return (
            <div className="h-[calc(100vh-56px)] bg-[#060d19] flex overflow-hidden">
                  <div className="w-64 border-r border-white/[0.06] flex flex-col bg-[#0a1628]/50">
                          ...
                          <div className="p-3 border-b border-white/[0.06]">
                                    <div className="text-white/40 text-[10px] font-mono tracking-wider mb-2">GEO SENSITIVITY</div>div>
                                                <div className="space-y-1 text-white/50 text-[10px] font-mono">{["military escalation", "energy supply disruption", "trade restrictions", "sanctions", "political instability"].map(g => (<div key={g}>{g}</div>div>))}</div>div>
                          </div>div>
